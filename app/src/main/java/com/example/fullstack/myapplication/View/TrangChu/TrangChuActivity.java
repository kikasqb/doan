...
import com.example.fullstack.myapplication.Adapter.ExpandAdater;
import com.example.fullstack.myapplication.Adapter.ViewPagerAdapter;
...
import com.example.fullstack.myapplication.Presenter.TrangChu.XuLyMenu.PresenterLogicXuLyMenu;
import com.example.fullstack.myapplication.R;
import com.example.fullstack.myapplication.View.DangNhap_DangKy.DangNhapActivity;
import com.example.fullstack.myapplication.View.GioHang.GioHangActivity;
import com.example.fullstack.myapplication.View.TimKiem.TimKiemActivity;
...
public class TrangChuActivity extends AppCompatActivity implements ViewXuLyMenu,GoogleApiClient.OnConnectionFailedListener,AppBarLayout.OnOffsetChangedListener{
    ...
    public static final String SERVER_NAME = "http://192.168.42.104/weblazada/loaisanpham.php";
    public static final String SERVER= "http://192.168.42.104/weblazada";
    Toolbar toolbar;
    TabLayout tabLayout;
    ViewPager viewPager;
...
//                    "com.example.fullstack.myapplication",
